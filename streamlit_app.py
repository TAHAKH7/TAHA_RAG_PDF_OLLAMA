...
def extract_model_names(_models_info):
    ...
    """
    # Log the structure of _models_info for inspection
    logger.info(f"Models info: {_models_info}")

    try:
        # Access model names from the correct key in the response
        model_names = tuple(model["model_id"] for model in _models_info["models"])  # Adjusted based on inspection
